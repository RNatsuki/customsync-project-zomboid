Custom Sync - Eliminate Desync in Project Zomboid Multiplayer!
...
- Advanced Zombie Handling: Immediate sync on hits, state changes, and death to prevent desync, revival, or missed attacks.
